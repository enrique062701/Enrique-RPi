========================================================================
    CONSOLE APPLICATION : tst_sup_unmanaged_c Project Overview
========================================================================

To create similar project:

1) In Visual Studio project wizard choose "Visual C++" -> "Win32 Console Application"
2) Main madified CPP file is tst_sup_unmanaged_c.cpp
3) copy REMOTECONTROL.H to project source files. It is optional, but you may with to 
   Project->Add Existing Item this header file. 
4) Project->Add REMOTECONTROL.LIB import library
5) copy add REMOTECONTROL.DLL, CANRS232.DLL and USBCAND.DLL dlls to target EXE folder
6) By default, when full path to CSV file is not specified, REMOTECONTROL.DLL looks for it in 
   EXE start folder. Visual Studio seems using project sources folder as EXE start folder. So
   for more easier debugging you may like to copy REMOTECONTROL.CSV to your sources folder
