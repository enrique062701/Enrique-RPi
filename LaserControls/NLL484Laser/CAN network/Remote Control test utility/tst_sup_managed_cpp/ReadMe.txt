Please use the following steps to recreate project

1. In Visual Studio new project wizard choose Visual C++ -> CLR -> CLR Console Application
2. Project->Properties->Common Properties->References->Add New Reference... and choose rcclass.dll
